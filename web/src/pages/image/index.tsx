...
import { imageGenerationLogStore as logStore, setGenerationRuntimeUsage } from "@/services/generation-log-storage";
...
export default function ImagePage() {
    ...
    useEffect(() => setGenerationRuntimeUsage("image-workbench", { references, results }), [references, results]);
    ...
    const deleteSelectedLogs = () => {
        void recordSyncDeletions("image-workbench", selectedLogIds);
